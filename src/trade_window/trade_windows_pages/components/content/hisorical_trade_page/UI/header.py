                        ...
                        ft.Container(
                            ft.Container(
                                ft.Row(controls=[
                                    ...
                                    ft.Container(ft.ElevatedButton(content = ft.Text('Избранные стратегии',size=12,),data='Избранные стратегии',on_click=self.change_page,bgcolor=c_yelow,color=c_blue,style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=0))),alignment=ft.alignment.center,margin=7,height=30),
                                ]),width=520),alignment=ft.alignment.center),height=60,margin=ft.margin.only(top=-14,left=-10,right=-10,bottom=-14),      
                    ),
                    ft.Container(
