...
# компонент - настройки стратегии CDL3INSIDE
import flet as ft
...
class CDL3INSIDE(ft.UserControl):
    def __init__(self):
        super().__init__()


    def input_CDL3INSIDE_long(self,e):
        Save_config('param_trade_historical_trade_svobodniy_freym',{'strat_CDL3INSIDE_long':str(e.control.value)})
    def input_CDL3INSIDE_short(self,e):
        Save_config('param_trade_historical_trade_svobodniy_freym',{'strat_CDL3INSIDE_short':str(e.control.value)})

    def print_component(self):
        config = configparser.ConfigParser()         
        config.read(path_imports_config)
        self.strat_CDL3INSIDE_long = config.get('param_trade_historical_trade_svobodniy_freym', 'strat_CDL3INSIDE_long')
        self.strat_CDL3INSIDE_short = config.get('param_trade_historical_trade_svobodniy_freym', 'strat_CDL3INSIDE_short')
                        ...
                        controls=[
                            ...
                            ft.Container(
                                ft.Container(
                                        ...
                                        Input(self.input_CDL3INSIDE_long,self.strat_CDL3INSIDE_long,350),
                                        ft.Container(ft.Text('Процент сигнала в шорт',size=12,color=c_white,text_align='center'),width=350),
                                        Input(self.input_CDL3INSIDE_short,self.strat_CDL3INSIDE_short,350),
                                ])),
                                width=396,
