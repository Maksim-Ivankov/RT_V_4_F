...
class Component_info_strat(ft.UserControl):
    def __init__(self,delete_strat):
        super().__init__()
    ...
    def print_component(self):
        ...
        for strat in literal_eval(self.strategys):
            ...
            # ]),padding=5,bgcolor=c_yelow,height=30,width=((len(strat)*10)+40)))
        
        # self.component_info_strat = ft.GridView(
