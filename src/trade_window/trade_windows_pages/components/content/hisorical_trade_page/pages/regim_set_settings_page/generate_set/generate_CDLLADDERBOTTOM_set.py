...
class Generate_CDLLADDERBOTTOM_set(ft.UserControl):
    ...
    def input_CDLLADDERBOTTOM_long(self,e):
        self.set_CDLLADDERBOTTOM_long = e.control.value
        Save_config('param_trade_historical_trade_svobodniy_freym',{'set_CDLLADDERBOTTOM_long':str(e.control.value)})
    def input_CDLLADDERBOTTOM_short(self,e):
        self.set_CDLLADDERBOTTOM_short = e.control.value
        Save_config('param_trade_historical_trade_svobodniy_freym',{'set_CDLLADDERBOTTOM_short':str(e.control.value)})
        
    

    def btn_generate(self,e):
        if os.path.exists(path_ini_CDLLADDERBOTTOM_set):
            os.remove(path_ini_CDLLADDERBOTTOM_set)
        for i in range(1,int(self.how_mach_settings)+1):
            Save_config(str(i)+'_section',{'long':str(random.choice(self.set_CDLLADDERBOTTOM_long.split(',')))},path_ini_CDLLADDERBOTTOM_set)
            Save_config(str(i)+'_section',{'short':str(random.choice(self.set_CDLLADDERBOTTOM_short.split(',')))},path_ini_CDLLADDERBOTTOM_set)
    ...
    def print_page(self):
        ...
        self.set_CDLLADDERBOTTOM_long = config.get('param_trade_historical_trade_svobodniy_freym', 'set_CDLLADDERBOTTOM_long')
        self.set_CDLLADDERBOTTOM_short = config.get('param_trade_historical_trade_svobodniy_freym', 'set_CDLLADDERBOTTOM_short')
                                                        ...
                                                        controls=[
                                                            ...
                                                            ft.Container(
                                                                ft.Container(
                                                                        ...
                                                                        Input(self.input_CDLLADDERBOTTOM_long,self.set_CDLLADDERBOTTOM_long,510),
                                                                        ft.Container(ft.Text('Процент сигнала в шорт',size=12,color=c_white,text_align='center'),width=510),
                                                                        Input(self.input_CDLLADDERBOTTOM_short,self.set_CDLLADDERBOTTOM_short,510),
                                                                ])),
                                                                width=550,
