...
class TRIMA_table(ft.UserControl):
    def __init__(self):
        super().__init__()
    ...
    def print_page(self):
        ...
        config_general_set.read(path_ini_TRIMA_set)
        count = 1
            ...
            ft.Container(
                ft.Column(controls=[
                    ft.DataTable(columns=[
                        ...
                        ft.DataColumn(ft.Text('Временной промежуток',text_align='center',color=c_white,size=12)),
                    ],rows = datas_print,
                    column_spacing = 54,
