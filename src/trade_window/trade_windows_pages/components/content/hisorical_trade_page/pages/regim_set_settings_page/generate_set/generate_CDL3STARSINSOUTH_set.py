...
class Generate_CDL3STARSINSOUTH_set(ft.UserControl):
    def __init__(self,btn_close):
        super().__init__()
        self.btn_close = btn_close
        
    def input_CDL3STARSINSOUTH_long(self,e):
        self.set_CDL3STARSINSOUTH_long = e.control.value
        Save_config('param_trade_historical_trade_svobodniy_freym',{'set_CDL3STARSINSOUTH_long':str(e.control.value)})
    def input_CDL3STARSINSOUTH_short(self,e):
        self.set_CDL3STARSINSOUTH_short = e.control.value
        Save_config('param_trade_historical_trade_svobodniy_freym',{'set_CDL3STARSINSOUTH_short':str(e.control.value)})
        
    

    def btn_generate(self,e):
        if os.path.exists(path_ini_CDL3STARSINSOUTH_set):
            os.remove(path_ini_CDL3STARSINSOUTH_set)
        for i in range(1,int(self.how_mach_settings)+1):
            Save_config(str(i)+'_section',{'long':str(random.choice(self.set_CDL3STARSINSOUTH_long.split(',')))},path_ini_CDL3STARSINSOUTH_set)
            Save_config(str(i)+'_section',{'short':str(random.choice(self.set_CDL3STARSINSOUTH_short.split(',')))},path_ini_CDL3STARSINSOUTH_set)
    ...
    def print_page(self):
        ...
        self.set_CDL3STARSINSOUTH_long = config.get('param_trade_historical_trade_svobodniy_freym', 'set_CDL3STARSINSOUTH_long')
        self.set_CDL3STARSINSOUTH_short = config.get('param_trade_historical_trade_svobodniy_freym', 'set_CDL3STARSINSOUTH_short')
                                                        ...
                                                        controls=[
                                                            ...
                                                            ft.Container(
                                                                ft.Container(
                                                                        ...
                                                                        Input(self.input_CDL3STARSINSOUTH_long,self.set_CDL3STARSINSOUTH_long,510),
                                                                        ft.Container(ft.Text('Процент сигнала в шорт',size=12,color=c_white,text_align='center'),width=510),
                                                                        Input(self.input_CDL3STARSINSOUTH_short,self.set_CDL3STARSINSOUTH_short,510),
                                                                ])),
                                                                width=550,
