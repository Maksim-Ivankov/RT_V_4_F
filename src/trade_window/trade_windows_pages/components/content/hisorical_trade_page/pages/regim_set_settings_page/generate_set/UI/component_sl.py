...
class Component_sl(ft.UserControl):
    ...
    def chech_fiks_dinamo(self,e):
        Save_config('param_trade_historical_trade_svobodniy_freym',{'set_general_regim_sl':e.control.data})
    ...
    def print_component(self):
        ...
        self.btn_click = config.get('param_trade_historical_trade_svobodniy_freym', 'set_general_regim_sl')
        self.general_input_sl = config.get('param_trade_historical_trade_svobodniy_freym', 'set_general_input_sl')
