...
class Generate_CDLCOUNTERATTACK_set(ft.UserControl):
    ...
    def btn_generate(self,e):
        ...
        for i in range(1,int(self.how_mach_settings)+1):
            Save_config(str(i)+'_section',{'koef_bistro':str(random.choice(self.koef_bistro.split(',')))},path_ini_CDLCOUNTERATTACK_set)
            Save_config(str(i)+'_section',{'koef_medleno':str(random.choice(self.koef_medleno.split(',')))},path_ini_CDLCOUNTERATTACK_set)
            Save_config(str(i)+'_section',{'sovpad_last':str(random.choice(self.sovpad_last.split(',')))},path_ini_CDLCOUNTERATTACK_set)
            Save_config(str(i)+'_section',{'up_chanal':str(random.choice(self.up_chanal.split(',')))},path_ini_CDLCOUNTERATTACK_set)
            Save_config(str(i)+'_section',{'down_chanal':str(random.choice(self.down_chanal.split(',')))},path_ini_CDLCOUNTERATTACK_set)
