...
class Generate_CDLDARKCLOUDCOVER_set(ft.UserControl):
    ...
    def input_strat_CDLDARKCLOUDCOVER_penetration(self,e):
        self.set_CDLDARKCLOUDCOVER_penetration = e.control.value
        Save_config('param_trade_historical_trade_svobodniy_freym',{'set_CDLDARKCLOUDCOVER_penetration':str(e.control.value)})
    def input_CDLDARKCLOUDCOVER_long(self,e):
        self.set_CDLDARKCLOUDCOVER_long = e.control.value
        Save_config('param_trade_historical_trade_svobodniy_freym',{'set_CDLDARKCLOUDCOVER_long':str(e.control.value)})
    def input_CDLDARKCLOUDCOVER_short(self,e):
        self.set_CDLDARKCLOUDCOVER_short = e.control.value
        Save_config('param_trade_historical_trade_svobodniy_freym',{'set_CDLDARKCLOUDCOVER_short':str(e.control.value)})
        
    

    def btn_generate(self,e):
        if os.path.exists(path_ini_CDLDARKCLOUDCOVER_set):
            os.remove(path_ini_CDLDARKCLOUDCOVER_set)
        for i in range(1,int(self.how_mach_settings)+1):
            Save_config(str(i)+'_section',{'penetration':str(random.choice(self.set_CDLDARKCLOUDCOVER_penetration.split(',')))},path_ini_CDLDARKCLOUDCOVER_set)
            Save_config(str(i)+'_section',{'long':str(random.choice(self.set_CDLDARKCLOUDCOVER_long.split(',')))},path_ini_CDLDARKCLOUDCOVER_set)
            Save_config(str(i)+'_section',{'short':str(random.choice(self.set_CDLDARKCLOUDCOVER_short.split(',')))},path_ini_CDLDARKCLOUDCOVER_set)
    ...
    def print_page(self):
        ...
        self.set_CDLDARKCLOUDCOVER_penetration = config.get('param_trade_historical_trade_svobodniy_freym', 'set_CDLDARKCLOUDCOVER_penetration')
        self.set_CDLDARKCLOUDCOVER_long = config.get('param_trade_historical_trade_svobodniy_freym', 'set_CDLDARKCLOUDCOVER_long')
        self.set_CDLDARKCLOUDCOVER_short = config.get('param_trade_historical_trade_svobodniy_freym', 'set_CDLDARKCLOUDCOVER_short')
                                                    ...
                                                    ft.Column(
                                                        controls=[
                                                            ...
                                                            ft.Container(
                                                                ft.Container(
                                                                        ft.Column(controls=[
                                                                        ft.Container(ft.Text('Процент проникновения одной свечи внутри другой свечи',size=12,color=c_white,text_align='center'),width=510),
                                                                        Input(self.input_strat_CDLDARKCLOUDCOVER_penetration,self.set_CDLDARKCLOUDCOVER_penetration,510),
                                                                        ft.Container(ft.Text('Процент сигнала в лонг',size=12,color=c_white,text_align='center'),width=510),
                                                                        Input(self.input_CDLDARKCLOUDCOVER_long,self.set_CDLDARKCLOUDCOVER_long,510),
                                                                        ft.Container(ft.Text('Процент сигнала в шорт',size=12,color=c_white,text_align='center'),width=510),
                                                                        Input(self.input_CDLDARKCLOUDCOVER_short,self.set_CDLDARKCLOUDCOVER_short,510),
                                                                ])),
                                                                width=550,
