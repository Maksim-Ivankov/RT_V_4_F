...
class Generate_CDLABANDONEDBABY_set(ft.UserControl):
    def __init__(self,btn_close):
        super().__init__()
        self.btn_close = btn_close
        
    def input_strat_CDLABANDONEDBABY_penetration(self,e):
        self.set_CDLABANDONEDBABY_penetration = e.control.value
        Save_config('param_trade_historical_trade_svobodniy_freym',{'set_CDLABANDONEDBABY_penetration':str(e.control.value)})
    def input_CDLABANDONEDBABY_long(self,e):
        self.set_CDLABANDONEDBABY_long = e.control.value
        Save_config('param_trade_historical_trade_svobodniy_freym',{'set_CDLABANDONEDBABY_long':str(e.control.value)})
    def input_CDLABANDONEDBABY_short(self,e):
        self.set_CDLABANDONEDBABY_short = e.control.value
        Save_config('param_trade_historical_trade_svobodniy_freym',{'set_CDLABANDONEDBABY_short':str(e.control.value)})
        
    

    def btn_generate(self,e):
        if os.path.exists(path_ini_CDLABANDONEDBABY_set):
            os.remove(path_ini_CDLABANDONEDBABY_set)
        for i in range(1,int(self.how_mach_settings)+1):
            Save_config(str(i)+'_section',{'penetration':str(random.choice(self.set_CDLABANDONEDBABY_penetration.split(',')))},path_ini_CDLABANDONEDBABY_set)
            Save_config(str(i)+'_section',{'long':str(random.choice(self.set_CDLABANDONEDBABY_long.split(',')))},path_ini_CDLABANDONEDBABY_set)
            Save_config(str(i)+'_section',{'short':str(random.choice(self.set_CDLABANDONEDBABY_short.split(',')))},path_ini_CDLABANDONEDBABY_set)
    ...
    def print_page(self):
        ...
        self.set_CDLABANDONEDBABY_penetration = config.get('param_trade_historical_trade_svobodniy_freym', 'set_CDLABANDONEDBABY_penetration')
        self.set_CDLABANDONEDBABY_long = config.get('param_trade_historical_trade_svobodniy_freym', 'set_CDLABANDONEDBABY_long')
        self.set_CDLABANDONEDBABY_short = config.get('param_trade_historical_trade_svobodniy_freym', 'set_CDLABANDONEDBABY_short')
                                                        ...
                                                        controls=[
                                                            ...
                                                            ft.Container(
                                                                ft.Container(
                                                                        ...
                                                                        Input(self.input_strat_CDLABANDONEDBABY_penetration,self.set_CDLABANDONEDBABY_penetration,510),
                                                                        ft.Container(ft.Text('Процент сигнала в лонг',size=12,color=c_white,text_align='center'),width=510),
                                                                        Input(self.input_CDLABANDONEDBABY_long,self.set_CDLABANDONEDBABY_long,510),
                                                                        ft.Container(ft.Text('Процент сигнала в шорт',size=12,color=c_white,text_align='center'),width=510),
                                                                        Input(self.input_CDLABANDONEDBABY_short,self.set_CDLABANDONEDBABY_short,510),
                                                                ])),
                                                                width=550,
