...
class Isbrannoe_page(ft.UserControl):
    ...
    def update_data_favorites(self,e):
                                    ...
                                    ft.Container(
                                        ft.Container(ft.Column(controls=[
                                                ...
                                                ft.Container(ft.Row(controls=[
                                                        ...
                                                        ft.Container(ft.Image(src='src/trade_window/trade_windows_pages/components/content/hisorical_trade_page/pages/isbrannoe_page/UI/img/pancil_blue.png'),bgcolor=c_yelow,width=30,height=30,padding=7,data=i,on_click=self.update_data_favorites),
